...
#             'SFTP Mode must be one of "local", "remote", or "both"', "value"
#         )
...
#             assetstorePath = (
#                 assetstore.get("root")
#                 if assetstore.get("type") == AssetstoreType.FILESYSTEM
#                 else None
#             )
...
#                 girder.logprint.info(
#                     "Available disk space for %s: %3.1f GB" % (pathkey, space / 1024**3)
#                 )
#         idx1 = ([("path", 1)], {})
